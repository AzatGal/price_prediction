...
def main(data_path=None):
    if data_path is None:
        ...
        unzip(data_path / 'acquire-valued-shoppers-challenge.zip')
    else:
    ...
    logger.info('Preprocessing ecom offers data')
    ...
    data_transactions = pl.read_csv(gzip.open(data_path/'transactions.csv.gz').read()).with_columns(
...
if __name__ == "__main__":
    main('/Users/azatgalautdinov/PycharmProjects/price_prediction/preprocessing/tmp/ecom-offers')
