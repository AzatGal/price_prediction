...
class _OneHotEncoding(nn.Module):
    ...
    **Examples**
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        Args:
            x: the categorical features. The datasets type must be `torch.long`.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            dtype: the parameter datasets type.
...
class TabM(nn.Module):
    ...
    **Shape**
    ...
    def make(cls, **kwargs) -> 'TabM':
        ...
        model-related arguments (datasets-related arguments are still required).
        More precisely:
    ...
    def forward(
        ...
        Args:
            x_num: the numerical features. The datasets type must be float.
            x_cat: the categorical features. The datasets type must be long.
