...
def main(data_path=None):
    if data_path is None:
        ...
        kaggle.api.competition_download_files('homesite-quote-conversion', path=data_path)
        unzip(data_path / 'homesite-quote-conversion.zip')
    else:
    ...
    data = pl.read_csv(zipfile.ZipFile(data_path/'train.csv.zip').read('train.csv'))
